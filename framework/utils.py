...
def fetch_html(url: str, remove_selectors: Optional[List[str]] = None, headless=True) -> str:
...
async def fetch_html_async(url: str, remove_selectors: Optional[List[str]] = None, headless=True) -> str:
...
def get_chunks(s: str, chunk_size: int, 
               chunk_overlap: int, seperator: str = "\n") -> List[str]:
